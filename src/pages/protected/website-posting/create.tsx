...
export default function WebsitePostCreate() {
    ...
    const createMutation = useMutation({
        mutationFn: (data: FormData) => api.createWebsitePost(data),
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setError(typeof msg === "object" ? Object.values(msg).flat().join(", ") : msg || "Failed to create website post");
        } finally {
    ...
    return (
        <div>
            <Box sx={{ mb: 3, display: "flex", alignItems: "center", gap: 2 }}>
                ...
                <div>
                    <h2 style={{ margin: 0 }}>Ongeza Website Posting</h2>
                    <p style={{ margin: "4px 0 0 0", color: "var(--text-secondary)" }}>Create a new post for the website homepage</p>
                </div>
            </Box>
            ...
            {isUploading && (
                <Box sx={{ mb: 3 }}>
                    <Typography variant="body2" sx={{ mb: 1 }}>{uploadProgress < 50 ? "Uploading cover image..." : "Creating post..."}</Typography>
                ...
                <Paper sx={{ flex: 1, minWidth: 300, p: 3 }}>
                    ...
                    {coverPreview ? (
                        ...
                        >
                            ...
                            <Typography variant="body2" sx={{ mt: 1 }}>Drag & drop or click to upload cover image</Typography>
                    ...
                    <form onSubmit={handleSubmit}>
                        <Box sx={{ display: "flex", flexDirection: "column", gap: 3 }}>
                            ...
                            <Box sx={{ display: "flex", gap: 2, justifyContent: "flex-end", mt: 2 }}>
                                ...
                                <Button type="submit" variant="contained" startIcon={<FaSave />} disabled={isUploading || !title.trim() || !coverFile} sx={{ backgroundColor: "#FF7A00", "&:hover": { backgroundColor: "#E66D00" } }}>
